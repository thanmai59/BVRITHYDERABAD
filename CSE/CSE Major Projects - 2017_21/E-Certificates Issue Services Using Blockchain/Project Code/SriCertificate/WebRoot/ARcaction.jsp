...
System.out.println("Generated hash Value is"+hkey);
 ...
 NoobChain.addBlock(new blockchain("Genesis", "0"));

NoobChain.addBlock(new blockchain(res,NoobChain.blockc.get(NoobChain.blockc.size()-1).hash));
System.out.println("\nThe blockchain: ");
NoobChain.displaychain();
