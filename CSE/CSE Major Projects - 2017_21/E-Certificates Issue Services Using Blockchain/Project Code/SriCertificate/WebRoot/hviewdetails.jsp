        ...
        <div id="container" class="container">
            ...
            <div>
                <ul class="nav nav-justified">
                  ...
                  <li><a href="hodleave.jsp">AddLeave</a></li>
                      <li><a href="hviewdetails.jsp">ViewHodLeaveDetails</a></li>
                      <li><a href="pviewdetails.jsp">ViewStaffLeaveDetails</a></li>
                    <li><a href="sviewdetails.jsp">ViewStudentLeaveDetails</a></li>
            ...
            <div class="abstract" style="background: "><br><br>
                ...
                <br><table style="margin-left: 280px;margin-top: -20px">
                    ...
                    <tr>
                        <%
                            try {
                                ...
                                ResultSet rs = st.executeQuery("select * from hodLeave");
                                while (rs.next()) {%>
                    ...
                    <% }
                            ...
                            e.printStackTrace();
                            System.out.println("Admin leave details Page" + e.getMessage());
                        }
                    %>
                </table>
            </div>
