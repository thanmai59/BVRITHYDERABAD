        ...
        <div id="container" class="container">
            ...
            <div style="border:1px solid white;width: 700px;height: 400px;margin-left: 300px;border-radius: 9px;background-color:grey;"><br />
                ...
                <form action="adminaction.jsp" method="post" style="width: 600px;height: 300px;margin-left: 80px;"><br />
                    <center> 
                    <label style="font-size: 25px;margin-left: -450px;color: white;margin-top: 50px">Admin Name </label><br />
                    ...
                    <input type="password" placeholder="Enter Password" required="" class="textbox" name="apass" style="margin-left: 30px"/><br /><br /><br />
  ...
  <body>
   <div class="wrapper col1">
		<div id="header">
         ...
         <br/>       <center><h1 style="color: white;">Welcome to Admin Login</h1></center>
                <form action="adminaction.jsp" method="post" style="width: 600px;height: 300px;margin-left: 80px;"><br />
                    <center> 
                    <br></br>
                    <label style="font-size: 25px;color: white;margin-top:50px">Admin Email </label>
                    <input type="text" placeholder="Enter Email Id" required="" class="textbox" name="aname"  /><br /><br />
                    <label style="font-size: 25px;color: white">Password  </label>
                   
                    <input type="password" placeholder="Enter Password" required="" class="textbox" name="apass" style="margin-left: 56px"/><br /><br /><br />
