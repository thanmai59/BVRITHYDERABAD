       ...
       <!--  <div id="container" class="container">
		...
		<div id="header">
           ...
           <li class="active"><a href="stuview.jsp">Home</a></li>
            ...
            <div class="abstract" style="background: ;margin-left:2%; height:95%;"><br><br>
                <center><h1 style="color: white;margin-top: -10px">Letter Details</h1></center>
                <br/>
                <br><table style="margin-left: 26%;margin-top: -20px">
                    <tr>
                        <!-- <th style="background-color: blue">Rollno</th>
                        <th style="background-color: blue">Name</th>
                        <th style="background-color: blue">Emailid</th> -->
                        <th style="background-color: blue">Faculty Name</th>
                    ...
                    <tr>
                        <%
                            try {
                                ...
                                ResultSet rs = st.executeQuery("select * from StudentRecLetter");
                                while (rs.next()) {%>
