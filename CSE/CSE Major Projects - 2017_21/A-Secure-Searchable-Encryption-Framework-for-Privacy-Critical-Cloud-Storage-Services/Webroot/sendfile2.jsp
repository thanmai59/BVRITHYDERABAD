...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">A Secure Searchable Encryption Framework for Privacy Critical Cloud Storage Services</span></a></h1>
      </div>
				...
				if(i<=5)
				{
					...
					if(rs1.next())
					{
						...
						if(length<mem1)
						{
							...
							st.executeUpdate("insert into  cfiles (oname,cname,fname,mac,key1,key2,pt,ct,dt) values ('"+uname+"','"+cname+"','"+fname+"','"+mac+"','"+String.valueOf(pub)+"','"+String.valueOf(priv)+"','"+pt+"','"+ct+"','"+strDate+"')");
