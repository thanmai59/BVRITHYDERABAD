      		...
      		String keyWord = "5765586965748666502846";
      			...
      			String encryptedValue = new String(Base64.encode(msg.getBytes()));
                               ...
                               Ftpcon  ftpcon = new Ftpcon();
                                ...
                                ftpcon.upload(f, tname);




   // new Ftpcon().upload(encryptedValue,tname);
          ...
          // public boolean upload(File file,String fname)
      		...
      		PrintStream p = new PrintStream(new FileOutputStream(tname));
			p.print(new String(msg));
			
			MessageDigest md = MessageDigest.getInstance("SHA1");
			FileInputStream fis11 = new FileInputStream(tname);
...
<form action="sendfile2.jsp" method="post"  name="form1">
  <table width="612" border="1" align="center">
    <tr>
      <td width="286"><span class="style4">Cloud Server:-  </span></td>
      <td width="339"><input type="text" name="t12" id="t12" value="<%= user %>" readonly></td>
    </tr>
    
    
    <tr>
      <td><span class="style4">File Name:- </span></td>
      <td><input type="text" name="t22" id="t22"  value="<%= tname %>" readonly></td>
    </tr>
    <tr>
      <td><span class="style4">File Content:-</span></td>
    ...
    <tr>
      <td><span class="style4">Encrypted File:- </span></td>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style1">
             <li class="style1"><a href="viewcloudrepu.jsp">Find Reputation</a></li>
            <li class="style1"><a href="viewcloudtrust.jsp">Find Trust Worthy</a></li>
            <li class="style1"><a href="viewcloudcost.jsp">Find Cost & Memory</a></li>
            <li class="style1"><a href="SendTrust.jsp">Send Trustworthiness of Cloud</a></li>
            <li class="style1"><a href="Delete.jsp">Delete</a></li>
            <li class="style1"><a href="viewcloudfiles.jsp">View Cloud Files</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
