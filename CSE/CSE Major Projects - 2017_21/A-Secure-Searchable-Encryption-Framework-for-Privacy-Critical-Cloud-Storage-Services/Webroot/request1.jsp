  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
             <li 
class="active"><a href="request1.jsp"><span>Request for SK</span></a></li>
          <li 
class="active" ><a href="reqfile.jsp"><span>Request for File</span></a></li>
          <li 
class="active"><a href="SendTrust0.jsp"><span>Feedback about Cloud</span></a></li>
          <li 
class="active"><a href="attackfeedback.jsp"><span>Attack Feedback</span></a></li>
          <li 
class="active"><a href="index.html"><span>Logout</span></a></li>
  ...
  <div class="content">
    ...
    <tr>
      <td><strong>Enter the File Name </strong></td>
      <td><input type="text" name="t2" /></td>
    </tr>
    <tr>
      <td><strong>Enter the Owner Name </strong></td>
		...
		else
		{
		 Statement stmt=connection.createStatement();
		    ...
		    if(rs.next()==true){
		    	...
		    	%> <p align="center" class="style3"><strong>Your File Secret Key is--<%=sk %></strong></p>
		    	<%
		    }
		    else
		    {
