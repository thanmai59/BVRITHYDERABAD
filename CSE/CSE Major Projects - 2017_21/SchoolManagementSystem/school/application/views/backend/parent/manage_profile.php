			...
			<!--div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content"-->
                    ...
                    foreach($edit_data as $row):
                        ?-->
                        <!--?php echo form_open(site_url('parents/manage_profile/update_profile_info/'.$row['parent_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
...
<!--div class="row">
	<div class="col-md-12"-->
        ...
        <br-->
        	<!--EDITING FORM STARTS---->
			<!-- class="tab-pane box active" id="list" style="padding: 5px">
