    ...
    <div class="row">
      <div class="col-md-12">
        <form class="form-horizontal form-groups" method="post"
          ...
          <!--div class="form-group">
            <label class="col-sm-3 control-label"><?php echo get_phrase('website_theme'); ?></label>
            <div class="col-sm-7">
              <?php $active_theme = $this->frontend_model->get_frontend_general_settings('theme');?>
              <select class="form-control" name="theme">
                <option <?php if($active_theme == 'ultimate')echo 'selected';?>>ultimate</option>
                <option <?php if($active_theme == 'default')echo 'selected';?>>default</option>
              </select>
            </div>
          </div-->
          <div class="form-group">
