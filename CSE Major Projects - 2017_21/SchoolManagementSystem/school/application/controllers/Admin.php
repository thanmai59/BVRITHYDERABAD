        ...
        if ($param1 == 'create') {
            ...
            if (!preg_match ("/^[a-zA-z]*$/", $data['name']) ) {  
                $ErrMsg = "Only alphabets and whitespace are allowed.";  
                       // echo $ErrMsg;  
                       $this->session->set_flashdata('error_message' , get_phrase('only aplhabets'));
            ...
            if(html_escape($this->input->post('phone')) != null){
             ...
             if (!preg_match ("/^[0-9]{10}$/", $data['phone']) ) {  
                $ErrMsgph = "Only 10 digits are allowed.";  
                       // echo $ErrMsg;  
                       $this->session->set_flashdata('error_message' , get_phrase('only 10 digit number'));
                    redirect(site_url('admin/student_add'), 'refresh');
            } else {  
                echo $data['phone'];  
            } 
