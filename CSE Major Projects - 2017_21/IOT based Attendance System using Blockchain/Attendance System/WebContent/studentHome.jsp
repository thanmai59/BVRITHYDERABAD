...
<%
try{
	String user = request.getParameter("rollNo");
	String rollNo = (String)session.getAttribute("rollNo");
	Connection con = ConnectionProvider.getCon();
	Statement st = con.createStatement();
	ResultSet rst = st.executeQuery("select * from student inner join attendance where student.rollNo=attendance.rollNo and student.rollNo='"+rollNo+"'");
	if(rst.next()) {
		if(user.equalsIgnoreCase(rollNo))
		{
%>
...
<body>
  ...
  <%
		...
		response.sendRedirect("errorReportView.html");
	}
	}
