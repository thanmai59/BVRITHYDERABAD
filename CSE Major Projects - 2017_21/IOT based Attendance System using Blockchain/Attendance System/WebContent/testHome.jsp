...
<img src="./images/vishnuLogo.png"  align="left"width="100" height="100">
  ...
  <div class="w3-bar w3-black">
    <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Report</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Attendance</button>
...
<body>
<jsp:include page="RecordAttendance.html"/>
...
<%
	try{
		...
		Connection con = ConnectionProvider.getCon();
		Statement st = con.createStatement();
		ResultSet rst = st.executeQuery("select * from attendance where rollNo='"+rollNo+"'");
		while(rst.next()){
			%>
        <tr>
           <td><%=rst.getString(1) %></td>
