            ...
            <div>
               ...
               <li class="active"><a href="fview.jsp">Home</a></li>
                    ...
                    <li><a href="fviewRecdetails.jsp">ViewRecommendationLetterDetails</a></li>
                      <!-- <li><a href="Fdownload1.jsp">SampleLetter</a> -->
                 
                    <li><a href="index.jsp">Logout</a></li>
                </ul>
            </div><br />
            <div style="border:1px solid white;width: 1250px;height: 400px;margin-left: 30px;border-radius: 40px;background-color: grey;">
               <br><h1 style="color: white;margin-right: 120px;margin-left: 500px;margin-top: -4px">Welcome faculty</h1>
            </div>
        </div> <!-- /container -->
        <div>
