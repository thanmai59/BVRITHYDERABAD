	 ...
	 <div>
            ...
            <br/>
                ...
                <form action="studentaction.jsp" method="post" style="width: 600px;height: 300px;margin-left: 80px;"><br />
                    <center> 
                    <br><br/>
                    <label style="font-size: 25px;color: white;margin-top: 50px">Student Name </label>
                    <input type="text" placeholder="Enter Email Id" required="" class="textbox" name="uname" /><br /><br/>
                    <label style="font-size: 25px;color: white">Password </label>
                    
                    <input type="password" placeholder="Enter Password" required="" class="textbox" name="pass" style="margin-left: 56px"/><br /><br /><br />
